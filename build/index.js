...
const deprecated = [{
  ...
  save: _ref => {
    ...
    let itemClasses = ['c-accordion__item', 'js-accordion-item', 'no-js'];
    let titleClasses = ['c-accordion__title', 'js-accordion-controller'];
    let contentStyles = {};
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      value: title
    }), subtitle.length > 0 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
      className: 'c-accordion__subtitle',
      tagName: 'span',
      value: subtitle
    }), duration.length > 0 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText.Content, {
...
/* harmony import */ var _html_tag_icon__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./html-tag-icon */ "./src/block/html-tag-icon.js");
/* harmony import */ var _utils_classnames__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/classnames */ "./src/utils/classnames.js");
...
const AccordionItemEdit = _ref => {
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.useBlockProps)({
    className: (0,_utils_classnames__WEBPACK_IMPORTED_MODULE_8__["default"])('c-accordion__item', 'js-accordion-item')
  });
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.BlockControls, {
    ...
    icon: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_html_tag_icon__WEBPACK_IMPORTED_MODULE_7__["default"], {
      tag: titleTag
    }),
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Reset These Settings to Defaults', 'accordion-blocks')))))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: 'js-accordion-controller'
    ...
    className: (0,_utils_classnames__WEBPACK_IMPORTED_MODULE_8__["default"])('c-accordion__title', {
      'c-accordion__title--button': titleTag === 'button'
    }),
    tagName: titleTag === 'button' ? 'div' : titleTag,
    allowedFormats: ['core/italic'],
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Titel des Abschnitts …', 'accordion-blocks'),
    value: title,
    onChange: value => setAttributes({
      title: value
    })
    ...
    className: 'c-accordion__subtitle',
    tagName: 'span',
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Untertitel (optional) …', 'accordion-blocks'),
    value: subtitle,
    onChange: value => setAttributes({
      subtitle: value
    })
    ...
    className: 'c-accordion__duration',
    tagName: 'span',
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Dauer (optional) …', 'accordion-blocks'),
    value: duration,
    onChange: value => setAttributes({
      duration: value
    })
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", innerBlocksProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.InnerBlocks, {
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)('ballschule/accordion-item', { ..._settings__WEBPACK_IMPORTED_MODULE_5__["default"],
  ...
  save: _ref => {
    ...
    let itemClasses = ['c-accordion__item', 'js-accordion-item', 'no-js'];
    let titleClasses = ['c-accordion__title'];
    let contentStyles = {};
...
/* harmony default export */ __webpack_exports__["default"] = ({
  from: [{
    ...
    transform: attributes => {
      return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('ballschule/accordion-item', {
        title: attributes.content,
        titleTag: 'h' + (attributes.level <= 4 ? attributes.level : 3)
      });
    }
  }, {
    type: 'block',
    ...
    transform: attributes => {
      return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('ballschule/accordion-item', {}, attributes.map(item => (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('core/paragraph', {
  ...
  to: [{
    ...
    transform: (attributes, innerBlocks) => {
      let newBlocks = innerBlocks.map(block => (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)(block.name, block.attributes));
      const level = attributes.titleTag !== 'button' ? parseInt(attributes.titleTag.replace('h', '')) : 3;
