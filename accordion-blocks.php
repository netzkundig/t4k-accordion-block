...
/**
 * Plugin Name: t4k Accordion Blocks
 * Description: Gutenberg blocks for creating responsive accordion drop-downs. Based on "Accordion Blocks" by Phil Buchanan https://github.com/philbuchanan/Accordion-Blocks
 * Version: 0.1.0
 * Requires at least: 5.9
 * Tested up to: 6.1
 * Requires PHP: 7.3
 * Author: Phil Buchanan; Edits by Eberhard Lauth / Netzkundig
...
class PB_Accordion_Blocks {
	...
	function __construct() {
		...
		add_action('render_block_ballschule/accordion-item', array($this, 'enqueue_assets_on_render'));
	}
	...
	public function enqueue_frontend_assets() {
		...
		if ($load_scripts_globally || has_block('ballschule/accordion-item', get_the_ID())) {
